...
\begin{titlepage}
    ...
    {\fontsize{65}{78}\selectfont \textbf{Proyecto final: Transferencia de estilos}}\\[0.5cm]   %Name of the book
    \textcolor{ColorSubtext}{\textsc{\Huge Redes Neuronales}}      %Name of the general theme
